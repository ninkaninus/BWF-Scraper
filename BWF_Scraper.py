...
for links in links_md:
    ...
    for x in range(100):
        ...
        MD.write(u';')
        MD.write(memberID[x * 2].findNext('td').contents[0])
        MD.write(u';')
        MD.write(memberID[x * 2].findNext('td').findNext('br').next_sibling)
        MD.write(u';\n')
...
for links in links_wd:
    ...
    for x in range(100):
        ...
        WD.write(u';')
        WD.write(memberID[x * 2].findNext('td').contents[0])
        WD.write(u';')
        WD.write(memberID[x * 2].findNext('td').findNext('br').next_sibling)
        WD.write(u';\n')
...
for links in links_mixd:
    ...
    for x in range(100):
        ...
        MIXD.write(u';')
        MIXD.write(memberID[x * 2].findNext('td').contents[0])
        MIXD.write(u';')
        MIXD.write(memberID[x * 2].findNext('td').findNext('br').next_sibling)
        MIXD.write(u';\n')
